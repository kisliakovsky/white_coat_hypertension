...
class ReportDataFrame(object):
    ...
    _START_TIME = DateTime.strptime("01.01.1970 8:00", _DATE_TIME_FORMAT)
    _FINISH_TIME = DateTime.strptime("02.01.1970 17:00", _DATE_TIME_FORMAT) + _TIME_INTERVAL
    _TIME_PERIOD = _FINISH_TIME - _START_TIME
    _FIRST_DAY_START_TIME = DateTime.strptime("01.01.1970 7:00", _DATE_TIME_FORMAT)
    _FIRST_NIGHT_START_TIME = DateTime.strptime("01.01.1970 23:00", _DATE_TIME_FORMAT)
